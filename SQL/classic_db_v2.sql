...
CREATE TABLE IF NOT EXISTS `creature` (
  ...
  `unique_waypoint_count` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'number of unique out of combat movement packet positions seen',
  `movement_type` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'guessed movement generator',
  `movement_flags` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table sniffs_new_test.creature_unique_ammo
...
CREATE TABLE IF NOT EXISTS `gameobject_template` (
  ...
  `icon_name` varchar(100) DEFAULT NULL COMMENT '1.12+',
  `opening_text` varchar(100) DEFAULT NULL COMMENT 'tbc+',
  `closing_text` varchar(100) DEFAULT NULL COMMENT 'tbc+',
