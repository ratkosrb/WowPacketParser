...
ALTER TABLE `item_template`
	CHANGE COLUMN `sniff_build` `sniff_build` INT(10) UNSIGNED NOT NULL DEFAULT '0' AFTER `entry`,
	CHANGE COLUMN `stat_type1` `stat_type1` TINYINT(3) NULL DEFAULT NULL AFTER `stats_count`,
	CHANGE COLUMN `stat_value1` `stat_value1` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type1`,
	CHANGE COLUMN `stat_type2` `stat_type2` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value1`,
	CHANGE COLUMN `stat_value2` `stat_value2` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type2`,
	CHANGE COLUMN `stat_type3` `stat_type3` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value2`,
	CHANGE COLUMN `stat_value3` `stat_value3` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type3`,
	CHANGE COLUMN `stat_type4` `stat_type4` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value3`,
	CHANGE COLUMN `stat_value4` `stat_value4` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type4`,
	CHANGE COLUMN `stat_type5` `stat_type5` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value4`,
	CHANGE COLUMN `stat_value5` `stat_value5` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type5`,
	CHANGE COLUMN `stat_type6` `stat_type6` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value5`,
	CHANGE COLUMN `stat_value6` `stat_value6` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type6`,
	CHANGE COLUMN `stat_type7` `stat_type7` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value6`,
	CHANGE COLUMN `stat_value7` `stat_value7` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type7`,
	CHANGE COLUMN `stat_type8` `stat_type8` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value7`,
	CHANGE COLUMN `stat_value8` `stat_value8` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type8`,
	CHANGE COLUMN `stat_type9` `stat_type9` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value8`,
	CHANGE COLUMN `stat_value9` `stat_value9` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type9`,
	CHANGE COLUMN `stat_type10` `stat_type10` TINYINT(3) NULL DEFAULT NULL AFTER `stat_value9`,
	CHANGE COLUMN `stat_value10` `stat_value10` SMALLINT(6) NULL DEFAULT NULL AFTER `stat_type10`,
	CHANGE COLUMN `dmg_min3` `dmg_min3` FLOAT NULL DEFAULT NULL AFTER `dmg_type2`,
	CHANGE COLUMN `dmg_max3` `dmg_max3` FLOAT NULL DEFAULT NULL AFTER `dmg_min3`,
	CHANGE COLUMN `dmg_type3` `dmg_type3` TINYINT(3) UNSIGNED NULL DEFAULT NULL AFTER `dmg_max3`,
	CHANGE COLUMN `dmg_min4` `dmg_min4` FLOAT NULL DEFAULT NULL AFTER `dmg_type3`,
	CHANGE COLUMN `dmg_max4` `dmg_max4` FLOAT NULL DEFAULT NULL AFTER `dmg_min4`,
	CHANGE COLUMN `dmg_type4` `dmg_type4` TINYINT(3) UNSIGNED NULL DEFAULT NULL AFTER `dmg_max4`,
	CHANGE COLUMN `dmg_min5` `dmg_min5` FLOAT NULL DEFAULT NULL AFTER `dmg_type4`,
	CHANGE COLUMN `dmg_max5` `dmg_max5` FLOAT NULL DEFAULT NULL AFTER `dmg_min5`,
	CHANGE COLUMN `dmg_type5` `dmg_type5` TINYINT(3) UNSIGNED NULL DEFAULT NULL AFTER `dmg_max5`,
	DROP PRIMARY KEY,
	ADD PRIMARY KEY (`entry`, `sniff_build`);
